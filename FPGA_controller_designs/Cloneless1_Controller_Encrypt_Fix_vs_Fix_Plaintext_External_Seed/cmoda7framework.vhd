...
architecture Structural of CmodA7framework is
    ...
    component Trivium is
        ...
        Port (  clk : in STD_LOGIC;
                rst : in STD_LOGIC;
                en : in STD_LOGIC;
                state_in : in STD_LOGIC_VECTOR(287 downto 0);
   ...
   signal input : STD_LOGIC_VECTOR(303 downto 0);
   signal output : STD_LOGIC_VECTOR(127 downto 0);
   signal randomness : STD_LOGIC_VECTOR(160 downto 0);
   signal plaintext : STD_LOGIC_VECTOR(123 downto 0);
   ...
   signal div_clk, target_reset, target_enable, target_done, rng_reset, rng_enable : STD_LOGIC;
   
   constant plaintext_0 : STD_LOGIC_VECTOR(123 downto 0) := x"14772336d467432396100caa1c52ad7";
   constant plaintext_1 : STD_LOGIC_VECTOR(123 downto 0) := x"2b5ba9ff57bf0bbdad9ebf0f72661b2";
...
begin
    ...
    generic map (size_ser => 8, size_par => 304)
    port map (
        clk => div_clk,
        rst => in_control(0),
        en => in_control(1),
    ...
    port map (
        ...
        iterations => input(303 downto 288),
        in_control => in_control,
        out_control => out_control
    );
    
    rng : Trivium
    generic map (output_bits => 161)
    port map (
        clk => div_clk,
        rst => rng_reset,
        en => rng_enable,
        state_in => input(287 downto 0),
        stream_out => randomness
    );

    plaintext <= plaintext_0 when (randomness(160) = '0') else plaintext_1;
